...
class Galeri_model extends CI_Model {
	...
	public function listing() {
		$this->db->select('galeri.*, kategori_galeri.nama_kategori_galeri, pegawai.nama_lengkap AS nama');
		$this->db->from('galeri');
		// Join dg 2 tabel
		$this->db->join('kategori_galeri','kategori_galeri.id_kategori_galeri = galeri.id_kategori_galeri','LEFT');
		$this->db->join('pegawai','pegawai.id_pegawai = galeri.id_pegawai','LEFT');
		// End join
	...
	public function galeri_home() {
		$this->db->select('galeri.*, kategori_galeri.nama_kategori_galeri, kategori_galeri.slug_kategori_galeri, , pegawai.nama_lengkap AS nama');
		$this->db->from('galeri');
		// Join dg 2 tabel
		$this->db->join('kategori_galeri','kategori_galeri.id_kategori_galeri = galeri.id_kategori_galeri','LEFT');
		$this->db->join('pegawai','pegawai.id_pegawai = galeri.id_pegawai','LEFT');
	...
	public function kategori_galeri($id_kategori_galeri,$limit,$start) {
		$this->db->select('galeri.*, pegawai.nama_lengkap AS nama, kategori_galeri.nama_kategori_galeri, kategori_galeri.slug_kategori_galeri');
		$this->db->from('galeri');
		// Join dg 2 tabel
		$this->db->join('kategori_galeri','kategori_galeri.id_kategori_galeri = galeri.id_kategori_galeri','LEFT');
		$this->db->join('pegawai','pegawai.id_pegawai = galeri.id_pegawai','LEFT');
