...
class Download_model extends CI_Model {
	...
	public function listing() {
		$this->db->select('download.*, kategori_download.nama_kategori_download, pegawai.nama_lengkap AS nama');
		...
		$this->db->join('pegawai','pegawai.id_pegawai = download.id_pegawai','LEFT');
		// End join
