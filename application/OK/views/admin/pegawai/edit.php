<?php 
echo form_open(base_url('admin/pegawai/edit/'.$pegawai->id_pegawai));
?>
<div class="col-md-12">
...
<div class="col-md-12">
	<div class="form-group form-group-lg has-success">
		...
		<select name="akses_level" class="form-control">
			...
			<option value="Kepala Puskesmas" 
			<?php if($pegawai->akses_level=="Kepala Puskesmas") { echo "selected"; } ?>
			>Kepala Puskesmas</option>
			<option value="Kepala TU" <?php if($pegawai->akses_level=="Kepala TU") { echo "selected"; } ?>>Kepala TU</option>
...
<div class="col-md-3">
	<div class="form-group form-group-lg has-error">
		<label>NRK</label>
		<input type="number" name="nrk" class="form-control" placeholder="NRK" value="<?php echo $pegawai->nrk ?>" required>
	</div>
</div>	
...
<div class="col-md-3">
	<div class="form-group form-group-lg has-error">
		<label>NIP</label>
		<input type="number" name="nip" class="form-control" placeholder="NIP" value="<?php echo $pegawai->nip ?>" required>
	</div>
</div>
...
<div class="col-md-3">
	<div class="form-group">
		...
		<?php if($pegawai->id_jenis_pegawai==$jenis->id_jenis_pegawai) { echo "selected"; } ?>
				>
