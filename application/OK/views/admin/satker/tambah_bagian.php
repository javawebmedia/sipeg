...
// Form buka 
echo form_open(base_url('admin/satker/bagian/'.$satker->id_satker));
?>

<div class="form-group">
<input type="text" name="nama_bagian" class="form-control" placeholder="Nama bagian bagian" value="<?php echo set_value('nama_bagian') ?>" required>
</div>
