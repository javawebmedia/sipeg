...
<?php 
echo form_open_multipart(base_url('admin/jabatan_fungsional/pegawai/'.$pegawai->id_pegawai)); 
?>
...
<div class="col-md-8">
	...
	<div class="form-group form-group-lg">
		...
		<input type="text" name="nama_jabatan_fungsional" class="form-control" placeholder="Nama Jabatan fungsional" value="<?php echo set_value('nama_jabatan_fungsional') ?>" required>
	</div>
</div>
