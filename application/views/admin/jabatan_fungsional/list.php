...
<p><a href="<?php echo base_url('admin/jabatan_fungsional/tambah') ?>" class="btn btn-primary">
<i class="fa fa-plus"></i> Kelola dan Tambah Data Jabatan fungsional</a></p>
<?php } ?>
...
<tr class="odd gradeX">
    ...
    <td><?php echo $jabatan_fungsional->nama_jabatan_fungsional ?>
      <br><small>Status: <?php echo $jabatan_fungsional->status_jabatan ?></small>
    </td>
