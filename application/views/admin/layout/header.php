...
<nav class="navbar navbar-static-top">
  ...
  <div class="navbar-custom-menu">
    <ul class="nav navbar-nav">
      ...
      <!-- NOTIFIKASI -->
      <?php
      // Load data yg mau pensiun
      include('pensiun.php');
      
      // Load data usulan struktural
      include('struktural.php');

      // Load data usulan fungsional
      include('fungsional.php');
    }
      ?>
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <img src="<?php if($pegawai_login->gambar=="") { echo base_url() ?>assets/admin/dist/img/user2-160x160.jpg<?php }else{ echo base_url('assets/upload/image/'.$pegawai_login->gambar); } ?>" class="user-image" alt="User Image">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-header">
            <img src="<?php if($pegawai_login->gambar=="") { echo base_url() ?>assets/admin/dist/img/user2-160x160.jpg<?php }else{ echo base_url('assets/upload/image/'.$pegawai_login->gambar); } ?>" class="img-circle" alt="User Image">
