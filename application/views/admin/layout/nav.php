      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url('admin/pegawai') ?>">
            <i class="fa fa-user"></i> <span>PROFIL PEGAWAI</span>
        </a></li>

        <!-- Pendidikan Pegawai -->
        <li>
          <a href="<?php echo base_url('admin/pendidikan') ?>">
            <i class="fa fa-graduation-cap"></i> <span>PENDIDIKAN PEGAWAI</span>
        </a></li>

        <!-- jabatan Pegawai -->
        <li>
          <a href="<?php echo base_url('admin/jabatan') ?>">
            <i class="fa fa-bar-chart"></i> <span>JABATAN STRUKTURAL</span>
        </a></li>

        <!-- jabatan fungsional Pegawai -->
        <li>
          <a href="<?php echo base_url('admin/jabatan_fungsional') ?>">
            <i class="fa fa-pie-chart"></i> <span>JABATAN FUNGSIONAL</span>
        </a></li>

        <!-- keluarga Pegawai -->
        <li>
          <a href="<?php echo base_url('admin/keluarga') ?>">
            <i class="fa fa-sitemap"></i> <span>KELUARGA</span>
        </a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('admin/jabatan_fungsional') ?>"><i class="fa fa-pie-chart"></i> Data Jabatan Fungsional</a></li>
